...
var expectedConf = &Config{
	GlobalConfig: GlobalConfig{
		...
		AcceptScrapeProtocols: DefaultGlobalConfig.AcceptScrapeProtocols,
	},
	...
	ScrapeConfigs: []*ScrapeConfig{
		...
		},
		{
			...
			AcceptScrapeProtocols: []ScrapeProtocol{"prometheusproto"},
...
var expectedErrors = []struct {
	...
	{
		filename: "scrape_config_files_accept_protocols.bad.yml",
		errMsg:   `parsing YAML file testdata/scrape_config_files_accept_protocols.bad.yml: accept_scrape_protocols: unknown scrape protocol unknown, supported:  "PrometheusText", "PrometheusProto", "OpenMetricsText" for scrape config with job name "node"`,
	},
	{
		filename: "scrape_config_files_accept_protocols2.bad.yml",
		errMsg:   `parsing YAML file testdata/scrape_config_files_accept_protocols2.bad.yml: duplicated protocol in accept_scrape_protocols, got [openmetricstext prometheusproto OpenMetricsText] for scrape config with job name "node"`,
	},
}
